...
class GestionCamions extends Controller{
    ...
    public function index(){ 
      ...
      if(isset($_SESSION["connectedUser"]) && $_SESSION["connectedUser"]["profil"]=="gestionCamions"){
        ...
        $this->view("camions/index"); // le parametre $path est une chaine de caractere correspondant au chemin du fichier a afficher, a partir du dosseir views
