...
class GestionHsse extends Controller{
    ...
    public function index(){ 
      ...
      if(isset($_SESSION["connectedUser"]) && $_SESSION["connectedUser"]["profil"]=="gestionHsse"){
        ...
        $this->view("hsse/index"); // le parametre $path est une chaine de caractere correspondant au chemin du fichier a afficher, a partir du dosseir views
